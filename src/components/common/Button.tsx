...
const Button: React.FC<ButtonProps> = ({ children, variant = 'primary', size = 'md', className, ...props }) => {
  ...
  const variantStyles = {
    ...
    icon:
      `p-2 rounded-full text-gray-600 hover:text-[#e04579] hover:bg-pink-100 active:bg-pink-200 focus:ring-2 focus:ring-[#e04579] focus:ring-offset-1 focus:ring-offset-white`,
  };
